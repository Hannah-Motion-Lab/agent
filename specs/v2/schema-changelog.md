...
- Canonical tagged tool file sources in `@hannah/llm`.
...
- Canonicalize ambient instruction traversal boundaries, honor `HANNAH_AGENT_DISABLE_PROJECT_CONFIG`, and make non-empty aggregate updates explicitly supersede previously loaded instructions.
