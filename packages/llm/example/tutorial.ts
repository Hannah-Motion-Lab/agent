...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@hannah/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@hannah/llm/route"
import { OpenAI } from "@hannah/llm/providers"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-hannah-agent-tutorial": "1" },
    query: { debug: "1" },
  },
})
