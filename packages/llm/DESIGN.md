...
> current private `@hannah/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@hannah/ai`
...
import { LLM } from "@hannah/ai"
import { OpenAI } from "@hannah/ai/providers/openai"
...
import { LLM, Tool } from "@hannah/ai"
...
```ts
import { LLM } from "@hannah/ai/promise"
import { OpenAI } from "@hannah/ai/providers/openai"
...
```ts
import { LLMSchema } from "@hannah/ai/schema"
...
```ts
import { Provider, Protocol } from "@hannah/ai/provider"
...
@hannah/ai/providers/openai
@hannah/ai/providers/anthropic
@hannah/ai/providers/google
...
```
