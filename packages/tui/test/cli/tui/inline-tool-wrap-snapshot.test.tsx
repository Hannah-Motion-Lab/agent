...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/agent/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/agent (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/agent/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/agent/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const HANNAH_AGENT_DB|HANNAH_AGENT_DB|HANNAH_AGENT_DEV|Global\\.Path\\.data|data =" in packages/agent/src (115 matches)',
  },
] as const
