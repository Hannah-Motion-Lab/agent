...
import { registerHannahSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@hannah/sdk/v2"
...
import { HANNAH_AGENT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useHannahKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.HANNAH_AGENT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
