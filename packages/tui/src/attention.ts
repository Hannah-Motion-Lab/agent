...
import defaultSoundPath from "@hannah/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@hannah/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@hannah/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@hannah/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@hannah/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@hannah/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "hannah-agent"
const DEFAULT_PACK_ID = "hannah-agent.default"
