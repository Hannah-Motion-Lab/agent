...
import { useBindings, useHannahModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useHannahModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.HANNAH_AGENT_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
