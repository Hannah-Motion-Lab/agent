...
export const TypeId: TypeId = "~@hannah/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@hannah/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@hannah/effect-sqlite-node/NodeSqliteClient")
