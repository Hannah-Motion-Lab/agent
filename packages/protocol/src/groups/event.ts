...
import { EventManifest } from "@hannah/schema/event-manifest"
import { Location } from "@hannah/schema/location"
import type { Definition } from "@hannah/schema/event"
...
export const HannahEvent = event.schema
export type HannahEvent = typeof HannahEvent.Type
export type OpenCodeEventEncoded = typeof HannahEvent.Encoded
