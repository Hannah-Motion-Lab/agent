...
- Effect plugins import `@hannah/plugin/v2/effect`, not `@hannah/core`.
- Public domain values use generated `@hannah/sdk` types.
...
- Define `PluginHost` domain capabilities in `@hannah/plugin/v2/effect`.
