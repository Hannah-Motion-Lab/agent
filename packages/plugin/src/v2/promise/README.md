...
The Promise plugin API is the async/await equivalent of `@hannah/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@hannah/plugin/v2/promise"
