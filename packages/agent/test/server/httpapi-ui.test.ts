  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("HANNAH_AGENT_SERVER_PASSWORD", original.envPassword)
        restoreEnv("HANNAH_AGENT_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            HANNAH_AGENT_SERVER_PASSWORD: input?.password,
            HANNAH_AGENT_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
