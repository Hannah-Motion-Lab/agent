...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      HANNAH_AGENT_EXPERIMENTAL_WORKSPACES: Flag.HANNAH_AGENT_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.HANNAH_AGENT_EXPERIMENTAL_WORKSPACES = original.HANNAH_AGENT_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
