...
describe("opencode read-only commands (smoke)", () => {
  ...
  // HANNAH_AGENT_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh HANNAH_AGENT_TEST_HOME means
  ...
  // in production it'd be a path under HANNAH_AGENT_TEST_HOME / XDG_DATA_HOME.
