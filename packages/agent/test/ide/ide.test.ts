...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders HANNAH_AGENT_CALLER", () => {
    process.env["HANNAH_AGENT_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode HANNAH_AGENT_CALLER", () => {
    process.env["HANNAH_AGENT_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown HANNAH_AGENT_CALLER", () => {
    process.env["HANNAH_AGENT_CALLER"] = "unknown"
