...
//   - HANNAH_AGENT_CONFIG_CONTENT      : provider config inline, no files to find
//   - HANNAH_AGENT_TEST_HOME           : pins os.homedir() → tmpdir
//   - HANNAH_AGENT_DISABLE_PROJECT_CONFIG : skip walking up for hannah-agent.json
//   - HANNAH_AGENT_PURE                : skip external plugin discovery + install
//   - HANNAH_AGENT_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    HANNAH_AGENT_TEST_HOME: home,
    HOME: home,
    XDG_CONFIG_HOME: path.join(home, ".config"),
    XDG_DATA_HOME: path.join(home, ".local/share"),
    XDG_STATE_HOME: path.join(home, ".local/state"),
    XDG_CACHE_HOME: path.join(home, ".cache"),
    HANNAH_AGENT_CONFIG_CONTENT: configJson,
    HANNAH_AGENT_DISABLE_PROJECT_CONFIG: "1",
    HANNAH_AGENT_PURE: "1",
    HANNAH_AGENT_DISABLE_AUTOUPDATE: "1",
    HANNAH_AGENT_DISABLE_AUTOCOMPACT: "1",
    HANNAH_AGENT_DISABLE_MODELS_FETCH: "1",
    HANNAH_AGENT_AUTH_CONTENT: "{}",
  }
}
  ...
  return Effect.gen(function* () {
    ...
    const runOpts = (opts?: RunOpts): SpawnOpts | undefined => {
      ...
      return {
        ...
        env: {
          ...opts.env,
          HANNAH_AGENT_CONFIG_CONTENT: JSON.stringify({
