...
import { SessionMessageTable } from "@hannah/core/session/sql"
...
import { Shell } from "@hannah/core/shell"
...
import { LocationServiceMap, locationServiceMapLayer } from "@hannah/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/agent/src/session/processor.ts")
