...
import type { NamedError } from "@hannah/core/util/error"
  ...
  test("maps free limits to Go upsell action", () => {
    ...
    expect(SessionRetry.retryable(error, "opencode")).toEqual({
      ...
      action: {
        ...
        message: "Subscribe to Hannah Go for reliable access to the best open-source models, starting at $5/month.",
        label: "subscribe",
