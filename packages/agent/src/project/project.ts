...
import { ProjectDirectoryTable, ProjectTable } from "@hannah/core/project/sql"
import { ProjectDirectories } from "@hannah/core/project/directories"
...
import { which } from "@hannah/core/util/which"
...
import { AppProcess } from "@hannah/core/process"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.HANNAH_AGENT_FAKE_VCS)
