import type { Hooks, PluginInput } from "@hannah/plugin"
import type { Model } from "@hannah/sdk/v2"
import { InstallationVersion } from "@hannah/core/installation/version"
import { OauthCallbackPage } from "@hannah/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Hannah will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
