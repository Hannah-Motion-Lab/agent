...
import { createHannahClient } from "@hannah/sdk"
...
import { InstallationChannel } from "@hannah/core/installation/version"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Plugin") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("Plugin.state")(function* (ctx) {
        ...
        const client = createHannahClient({
