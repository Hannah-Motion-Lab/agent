...
import type * as SDK from "@hannah/sdk/v2"
...
import { SessionShareTable } from "@hannah/core/share/sql"
import { ProviderV2 } from "@hannah/core/provider"
import { ModelV2 } from "@hannah/core/model"
import { EventV2 } from "@hannah/core/event"

const disabled = process.env["HANNAH_AGENT_DISABLE_SHARE"] === "true" || process.env["HANNAH_AGENT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/ShareNext") {}
