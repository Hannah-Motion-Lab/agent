...
import { buildPrompt } from "@hannah/core/session/compaction"
import { SessionCompactionEvent } from "@hannah/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/SessionCompaction") {}
