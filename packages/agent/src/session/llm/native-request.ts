import type { JsonSchema, LLMRequest, ProviderMetadata } from "@hannah/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@hannah/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @hannah/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
