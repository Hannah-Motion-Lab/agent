...
const USER_AGENT = `hannah-agent/${InstallationVersion}`
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("opencode")
        ? {
            ...(opencodeProjectID ? { "x-hannah-agent-project": opencodeProjectID } : {}),
            "x-hannah-agent-session": input.sessionID,
            "x-hannah-agent-request": input.user.id,
            "x-hannah-agent-client": input.flags.client,
