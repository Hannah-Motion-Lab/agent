...
import { llmClient } from "@hannah/core/effect/app-node-platform"
...
import type { LLMEvent } from "@hannah/llm"
import { LLMClient } from "@hannah/llm/route"
import type { LLMClientService } from "@hannah/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @hannah/llm. It
