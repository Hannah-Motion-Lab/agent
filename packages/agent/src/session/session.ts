...
import { locationServiceMapLayer } from "@hannah/core/location-services"
...
import { PartTable, SessionTable } from "@hannah/core/session/sql"
...
import { NonNegativeInt, optional } from "@hannah/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".hannah-agent", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Session") {}
