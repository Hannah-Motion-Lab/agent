...
import type { Event, GlobalEvent, HannahClient } from "@hannah/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@hannah-agent/RunStreamTransport") {}
