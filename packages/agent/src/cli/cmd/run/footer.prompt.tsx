...
import { normalizePromptContent } from "@hannah/tui/editor"
...
import { HANNAH_AGENT_BASE_MODE, useBindings } from "@hannah/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Hannah" } satisfies SlashOption,
    ]
