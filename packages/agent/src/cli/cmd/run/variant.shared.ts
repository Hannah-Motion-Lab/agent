...
//
// The saved variant persists across sessions in ~/.local/state/hannah-agent/model.json
...
class Service extends Context.Service<Service, VariantService>()("@hannah-agent/RunVariant") {}
