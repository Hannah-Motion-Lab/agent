...
import { openEditor } from "@hannah/tui/editor"
import { registerHannahKeymap } from "@hannah/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerHannahKeymap(keymap, renderer, input.tuiConfig)
