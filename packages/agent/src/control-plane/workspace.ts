...
import { EventSequenceTable, EventTable } from "@hannah/core/event/sql"
...
import { WorkspaceEvent } from "@hannah/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        HANNAH_AGENT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        HANNAH_AGENT_WORKSPACE_ID: config.id,
        HANNAH_AGENT_EXPERIMENTAL_WORKSPACES: "true",
