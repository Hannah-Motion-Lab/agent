...
import { SkillPlugin } from "@hannah/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@hannah/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@hannah/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@hannah/core/util/glob"
...
const HANNAH_AGENT_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with hannah-agent. The model's intuition for what an
// hannah-agent.json should look like is often wrong, and hannah-agent hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch hannah-agent's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_HANNAH_AGENT_SKILL_NAME = "customize-hannah-agent"
const CUSTOMIZE_HANNAH_AGENT_SKILL_DESCRIPTION =
...
const CUSTOMIZE_HANNAH_AGENT_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, HANNAH_AGENT_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@hannah-agent/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_HANNAH_AGENT_SKILL_NAME] = {
          name: CUSTOMIZE_HANNAH_AGENT_SKILL_NAME,
          description: CUSTOMIZE_HANNAH_AGENT_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_HANNAH_AGENT_SKILL_BODY,
        }
