...
import { IdeEvent } from "@hannah/schema/ide-event"
...
export function alreadyInstalled() {
  return process.env["HANNAH_AGENT_CALLER"] === "vscode" || process.env["HANNAH_AGENT_CALLER"] === "vscode-insiders"
}
...
export async function install(ide: (typeof SUPPORTED_IDES)[number]["name"]) {
  ...
  // Upstream's marketplace extension id — a third-party artifact, not our branding.
