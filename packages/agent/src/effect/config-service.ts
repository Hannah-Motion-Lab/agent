 ...
 *   "@hannah/ServerAuthConfig",
 *   {
 *     password: Config.string("HANNAH_AGENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("HANNAH_AGENT_SERVER_USERNAME").pipe(Config.withDefault("hannah-agent")),
 *   },
 * ) {}
 *
