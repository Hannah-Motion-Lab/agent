...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@hannah/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/ToolRegistry") {}
