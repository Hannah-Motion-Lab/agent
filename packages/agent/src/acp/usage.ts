...
import type { AssistantMessage as HannahAssistantMessage, Message } from "@hannah/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@hannah/core/effect/app-node"
...
export type AssistantTokenCost = Pick<HannahAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<HannahAssistantMessage, "role"> &
  Partial<Pick<HannahAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@hannah-agent/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@hannah-agent/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@hannah-agent/ACPUsage") {}
