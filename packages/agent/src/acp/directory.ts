...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@hannah-agent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@hannah-agent/ACPDirectory") {}
