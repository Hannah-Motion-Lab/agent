...
import { path } from "@hannah/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@hannah/core/project"
...
import { WorktreeEvent } from "@hannah/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `hannah-agent/${name}`
