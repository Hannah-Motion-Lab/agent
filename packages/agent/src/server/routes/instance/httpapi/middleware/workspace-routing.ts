...
>()("@hannah/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@hannah/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.HANNAH_AGENT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.HANNAH_AGENT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-hannah-agent-directory"] || process.cwd()
}
