...
import { makeApi } from "@hannah/protocol/api"
import { LocationMiddleware } from "@hannah/server/location"
import { SessionLocationMiddleware } from "@hannah/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("hannah-root")
...
export const InstanceHttpApi = HttpApi.make("hannah-instance")
...
export const HannahHttpApi = HttpApi.make("hannah-agent")
