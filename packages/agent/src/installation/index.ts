...
import { InstallationChannel, InstallationVersion } from "@hannah/core/installation/version"
import { NpmConfig } from "@hannah/core/npm-config"
import { InstallationEvent } from "@hannah/schema/installation-event"
...
export function userAgent(client = "cli") {
  return `hannah-agent/${InstallationChannel}/${InstallationVersion}/${client}`
}
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Installation") {}
  ...
  Effect.gen(function* () {
    ...
    const result: Interface = {
      ...
      method: Effect.fn("Installation.method")(function* () {
        if (process.execPath.includes(path.join(".hannah-agent", "bin"))) return "curl" as Method
