...
import { ModelV2 } from "@hannah/core/model"
import { SessionV2 } from "@hannah/core/session"
import { Agent } from "@hannah/schema/agent"
import { Location } from "@hannah/schema/location"
import { Model } from "@hannah/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@hannah/schema/prompt"
import { Provider } from "@hannah/schema/provider"
import { Project } from "@hannah/schema/project"
import { ProjectDirectories } from "@hannah/schema/project-directories"
import { PermissionV1 } from "@hannah/schema/permission-v1"
import { Session } from "@hannah/schema/session"
import { SessionInput } from "@hannah/schema/session-input"
import { SessionMessage } from "@hannah/schema/session-message"
import { Workspace } from "@hannah/schema/workspace"
import { Command } from "@hannah/schema/command"
import { Connection } from "@hannah/schema/connection"
import { Credential } from "@hannah/schema/credential"
import { FileSystem } from "@hannah/schema/filesystem"
import { Integration } from "@hannah/schema/integration"
import { LLM } from "@hannah/schema/llm"
import { Permission } from "@hannah/schema/permission"
import { Plugin } from "@hannah/schema/plugin"
import { Pty } from "@hannah/schema/pty"
import { Reference } from "@hannah/schema/reference"
import { SessionTodo } from "@hannah/schema/session-todo"
import { Skill } from "@hannah/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@hannah/schema/schema"
import { ProviderV2 } from "@hannah/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@hannah/core/command"),
    import("@hannah/core/integration/connection"),
    import("@hannah/core/credential"),
    import("@hannah/core/filesystem"),
    import("@hannah/core/integration"),
    import("@hannah/core/location"),
    import("@hannah/llm"),
    import("@hannah/core/permission"),
    import("@hannah/core/v1/permission"),
    import("@hannah/core/project/copy"),
    import("@hannah/core/pty"),
    import("@hannah/core/project/schema"),
    import("@hannah/core/reference"),
    import("@hannah/core/session/input"),
    import("@hannah/core/session/message"),
    import("@hannah/core/session/todo"),
    import("@hannah/core/session/prompt"),
    import("@hannah/core/skill"),
    import("@hannah/core/v2-schema"),
    import("@hannah/core/schema"),
    import("@hannah/core/workspace"),
  ])
