...
import { ListAnchor } from "@hannah/schema/session"
...
import { SessionDurable } from "@hannah/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/v2/Session") {}
