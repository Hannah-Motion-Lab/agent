...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@hannah/llm"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/v2/ToolRegistry") {}
