...
import { Event } from "@hannah/schema/project-directories"
import { ProjectCopy } from "@hannah/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/ProjectCopy") {}
