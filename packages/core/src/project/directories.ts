...
import type { EffectDrizzleSqlite } from "@hannah/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/ProjectDirectories") {}
