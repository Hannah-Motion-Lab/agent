...
import { type Model } from "@hannah/llm"
import * as AnthropicMessages from "@hannah/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@hannah/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@hannah/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@hannah/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/v2/SessionRunnerModel") {}
