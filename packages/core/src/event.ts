...
import { Event } from "@hannah/schema/event"
import type { Data, Definition, Payload } from "@hannah/schema/event"
...
import { Durable } from "@hannah/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@hannah/schema/event").ID
export type { Data, Definition, Payload } from "@hannah/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/Event") {}
