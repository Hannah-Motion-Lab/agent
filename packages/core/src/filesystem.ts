...
import { Entry, FileSystem, FindInput, Match } from "@hannah/schema/filesystem"
export { Entry, Match, Submatch } from "@hannah/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@hannah/v2/FileSystem") {}
