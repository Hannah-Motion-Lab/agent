...
import { FileSystemWatcher } from "@hannah/schema/filesystem-watcher"
...
declare const HANNAH_AGENT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof HANNAH_AGENT_LIBC === "undefined" ? undefined : HANNAH_AGENT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@hannah/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.HANNAH_AGENT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.HANNAH_AGENT_EXPERIMENTAL_FILEWATCHER)) {
