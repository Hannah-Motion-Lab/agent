...
export class Service extends Context.Service<Service, Interface>()("@hannah/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.HANNAH_AGENT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
