...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new HannahClient()" to fix this error.`)
    }
    return instance
  }
...
export class HannahClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<HannahClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    HannahClient.__registry.set(this, args?.key)
  }
